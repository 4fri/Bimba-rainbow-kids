            ...
            <div class="d-flex align-items-center justify-content-between w-100">
                <div class="d-flex align-items-center"><a
                        ...
                        <div class="brand-text d-none d-md-inline-block text-uppercase letter-spacing-0">
                            <span class="text-white fw-normal text-xs">BIMBA
                                <strong class="text-primary text-sm">Rainbow Kids</strong>
                            </span>
                ...
                <ul class="nav-menu mb-0 list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <li><a class="dropdown-item py-3" href="#!">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3"><span
                                                ...
                                                have 6 new messages </span><small class="small text-gray-600">4
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link text-white position-relative" id="messages"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end mt-sm-3 shadow-sm" aria-labelledby="messages">
                            <li><a class="dropdown-item d-flex py-3" href="#!"> <img
                                        ...
                                        src="{{ asset('template') }}/img/avatar-1.jpg" alt="..." width="45">
                                    <div class="ms-3"><span
                            ...
                            <li><a class="dropdown-item d-flex py-3" href="#!"> <img
                                        class="img-fluid rounded-circle flex-shrink-0 avatar shadow-0"
                                        src="{{ asset('template') }}/img/avatar-2.jpg" alt="..." width="45">
                                    <div class="ms-3"><span
                                            class="h6 d-block fw-normal mb-1 text-sm text-gray-600">Jason
                                            Doe</span><small class="small text-gray-600"> Sent You
                                            Message</small>
                            ...
                            <li><a class="dropdown-item d-flex py-3" href="#!"> <img
                                        class="img-fluid rounded-circle flex-shrink-0 avatar shadow-0"
                                        src="{{ asset('template') }}/img/avatar-3.jpg" alt="..." width="45">
                                    <div class="ms-3"><span
                                            class="h6 d-block fw-normal mb-1 text-sm text-gray-600">Jason
                                            Doe</span><small class="small text-gray-600"> Sent You
                                            Message</small>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-white text-sm" rel="nofollow" data-bs-target="#"
